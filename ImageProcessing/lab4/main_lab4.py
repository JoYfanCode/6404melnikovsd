...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Асинхронная загрузка и параллельная обработка "
            "изображений животных через API."
        ),
    ...
    parser.add_argument(
        ...
        type=str,
        default='lab4_images',
        help='Директория для сохранения результатов (по умолчанию: lab4_images)',
    )
